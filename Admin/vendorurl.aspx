<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendorurl.aspx.cs" Inherits="admin_Default" %>
...
<head runat="server">
    <title>Add Vendor URL :: Admin</title>
    <meta charset="utf-8" />
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="vendorurl.aspx"><i class="fa fa-fw fa-dashboard"></i>Manage Vendor Url</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
...
<div id="page-wrapper">
   ...
   <asp:DataList ID="DataList1" runat="server">
                        <ItemTEMPLATE> 
                            ...
                            <table cellpadding="0">
                                <tr class="even">
                                    <th>Vendor Name</th><th>URL</th>
                                </tr>
                                   <td class="even">
                                       <asp:Label ID="Label2" runat="server" Text='<%#Eval("VendorName") %>'></asp:Label>
                                    </td>
                                    <td class="even">
                                    ...
                                    <td>
                                        ...
                                        <asp:ConfirmButtonExtender ID="LinkButton2_ConfirmButtonExtender" runat="server" ConfirmOnFormSubmit="True" ConfirmText="Do You Want To Delete URL??" Enabled="True" TargetControlID="LinkButton2">
    ...
    <table class="auto-style1">
        <tr class="even">
            <td colspan="2">Enter Vendor URL </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr class="even">
            <td>Choose Vendor : </td>
            <td>    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown-header" Height="20px" Width="364px">
    </asp:DropDownList>
</td>
        </tr>
        <tr>
        ...
        <tr class="even">
            <td>Enter URL :</td>
            <td>
    <asp:TextBox ID="TextBox1" runat="server" CssClass="nav-justified"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr class="even">
            <td colspan="2">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button1" runat="server" Text="Submit"  CssClass="btn-info active" Height="42px" OnClick="Button1_Click" Width="247px"/>            
            </td>
        </tr>
    </table>
    <br />
