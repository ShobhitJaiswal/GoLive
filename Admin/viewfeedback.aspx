<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewfeedback.aspx.cs" Inherits="admin_bootstrap_elements" %>
...
<body>
 ...
 <!-- Top Menu Items -->
             <ul class="nav navbar-right top-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-child"></i>  <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label> <b class="caret"></b></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                      <asp:DataList ID="DataList1" runat="server" Width="1187px">
                       <ItemTEMPLATE> 
                            <table cellpadding="0">
                                <tr class="even">
                                    <th>Name</th><th>E-Mail</th><th>User Type</th><th>Message</th>
                                </tr>
                                <tr class="even">
                                    <td>
                                        Name :
