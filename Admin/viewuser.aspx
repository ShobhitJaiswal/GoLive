<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewuser.aspx.cs" Inherits="admin_bootstrap_elements" %>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                                <asp:DataList ID="DataList1" runat="server" Height="1100px" Width="1153px">
                        <ItemTEMPLATE> 
                              <br />
                            <table cellpadding="0">
                                <tr class="even">
                                    <th>User Name</th><th>Full Name</th><th>E-Mail</th>
                                </tr>
                                </tr>
                                <td class="even">
                                ...
                                <td>
                                    ...
                                    <asp:ConfirmButtonExtender ID="LinkButton2_ConfirmButtonExtender" runat="server" ConfirmOnFormSubmit="True" ConfirmText="Do You Want To Delete User??" Enabled="True" TargetControlID="LinkButton2">
