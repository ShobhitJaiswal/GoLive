<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewvendor.aspx.cs" Inherits="admin_bootstrap_elements" %>
 ...
 <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                    <li class="dropdown">
                        ...
                        <li class="divider"></li>
                                                        <li>
                                <asp:LinkButton ID="Logout" runat="server" OnClick="Lou">Logout</asp:LinkButton>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                                <asp:DataList ID="DataList1" runat="server" Width="800px" CellPadding="3" BorderStyle="None" CellSpacing="2" GridLines="Both">
                                    <HeaderStyle Font-Bold="True" />
                        <ItemTEMPLATE>
                            <table cellpadding="0">
                                	<tr><th>Logo</th><th>User Name</th><th>Vendor Name</th><th>E-Mail</th></tr>
                                <tr class='even'>
                                    <td>
                                        <asp:Image ID="Image1" runat="server" Height="100px" ImageAlign="Middle" Width="240px" ImageUrl='<%#"~/Vendor/VendorLogo/"+Eval("Logo") %>' />
                                    </td>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%#Eval("Id") %>' OnClick="LinkButton1_Click">Delete</asp:LinkButton>
                                        <asp:ConfirmButtonExtender ID="LinkButton1_ConfirmButtonExtender" runat="server" ConfirmOnFormSubmit="True" ConfirmText="Do You Want To Delete User??" Enabled="True" TargetControlID="LinkButton1">
