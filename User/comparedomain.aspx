<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comparedomain.aspx.cs" Inherits="support" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Compare Domain :: GoLive</title>
            ...
            <div class="wrap">
                ...
                <div class="row-indent">
                    ...
                    <div class="gray-blurb">
                        <div id="query">
                            <h4 class="ui-heading">Domains Comparison :</h4>
                            <p>&nbsp;</p>
                            <p>&nbsp;</p>
                            <div class="grids-hosting">
                                Choose Domain Name :
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="frm-select">
                                </asp:DropDownList>
                                <br />
                                <br />
                                <asp:Button ID="Button1" runat="server" CssClass="uiButton1" OnClick="Button1_Click" Text="Compare &gt;&gt;" />
                            </div>
