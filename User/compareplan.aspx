<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compareplan.aspx.cs" Inherits="login" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Compare Plan :: GoLive</title>
            ...
            <div class="wrap">
                ...
                <div class="row-indent">
                    ...
                    <div class="gray-blurb">
                        <div id="query">
                            <h4 class="ui-heading">Hosting Plans Comparison :</h4>
                            <p>&nbsp;</p>
                            <p>&nbsp;</p>
                            <div class="grids-hosting">
                                Choose Platform :
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="frm-select" AutoPostBack="True">
                                ...
                                <br />
                                Choose Plantype :                                              
                                 <asp:DropDownList ID="DropDownList2" runat="server" CssClass="frm-select" AutoPostBack="True">
                                     <asp:ListItem>Select Plantype</asp:ListItem>
                                ...
                                <asp:Button ID="Button1" runat="server" CssClass="uiButton1" Text="Compare &gt;&gt;" OnClick="Button1_Click" />
                            </div>
<p><h2><a href="ratereview.aspx">Review & Rating</a></h2>                            </p>
                            <br />
                            <br />
                        </div>
                    </div>
