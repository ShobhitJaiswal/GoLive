<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="css_userregistration" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update :: GoLive</title>
       ...
       <div class="header">
        ...
        <div class="bulk-domain">
            <div class="content">
                                        ...
                                        <div>
                                            <label>
                                                &nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True">
                                                    <asp:ListItem>Choose Type of Update</asp:ListItem>
                                                    <asp:ListItem>Update Plan</asp:ListItem>
                                                    <asp:ListItem>Update Domain</asp:ListItem>
                                                </asp:DropDownList>
                                            </label>
                                        </div>
                                    </td>
                ...
                <br />
                        <br>
                        <asp:Button ID="next" runat="server" name="Checkout" class="uiButton" Text="Next&gt;&gt;" OnClick="next_Click" CssClass="uiButton1" />
                    </div>
                </div>
            </div>
        </div>
