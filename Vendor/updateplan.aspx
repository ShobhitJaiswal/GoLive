<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateplan.aspx.cs" Inherits="support" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update Plan :: GoLive</title>
            ...
            <div class="wrap">
                <div class="support-desc">
                    ...
                    <div class="gray-blurb">
                        <div id="query">
                            <h4 class="ui-heading">Update Plans:</h4>
                            <br />
                            <br />
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
                                ...
                                OnRowDeleting="GridView1_RowDeleting" Width="997px" ShowFooter="True" Height="163px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TEMPLATEField HeaderText="Platform">
                                        ...
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_pf" runat="server" Text='<%# Eval("Platform") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="Plan Type">
                                        ...
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_pt" runat="server" Text='<%# Eval("PlanType") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="Websites">
                                        ...
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_wb" runat="server" Text='<%# Eval("Websites") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="Space Size">
                                        <ItemTEMPLATE>
                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("SpaceSize") %>'></asp:Label>
                                        </ItemTEMPLATE>
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_ss" runat="server" Text='<%# Eval("SpaceSize") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="E-Mail Size">
                                        <ItemTEMPLATE>
                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("Email_size") %>'></asp:Label>
                                        </ItemTEMPLATE>
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_es" runat="server" Text='<%# Eval("Email_size") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="FTP Size">
                                        <ItemTEMPLATE>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Ftp_size") %>'></asp:Label>
                                        </ItemTEMPLATE>
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_fs" runat="server" Text='<%# Eval("Ftp_size") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                    <asp:TEMPLATEField HeaderText="Plan Price">
                                        ...
                                        <EditItemTEMPLATE>
                                            <asp:TextBox ID="txt_pp" runat="server" Text='<%# Eval("PlanPrice") %>'></asp:TextBox>
                                        </EditItemTEMPLATE>
                                    </asp:TEMPLATEField>
                                </Columns>
